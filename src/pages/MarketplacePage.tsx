...
import { ShoppingBag, Tag, Plus, Store, X, Check, Loader2, ShieldCheck, AlertCircle, RotateCcw } from 'lucide-react';
      ...
      {showSellForm && user && (
        <div className="mt-6 card animate-fade-in p-6">
          ...
          <div className="mt-5 flex gap-2">
            <button onClick={createListing} disabled={!sellBookId || !sellPrice || submitting} className="btn-primary">
